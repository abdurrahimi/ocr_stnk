...
from Controller import cListRole


class listRoleUI(QMainWindow):
    def __init__(self, parent=None):
        super(listRoleUI, self).__init__(parent)
        self.resize(900, 700)
        self.setupUi()
    ...
    def retranslateUi(self):
        ...
        self.setWindowTitle(_translate("MainWindow", "List Role"))
    ...
    def handleBack(self, obj):
        #print("masuk sad")
        loginc  = cListRole.cListRole()
        loginc.gotodash(self)
